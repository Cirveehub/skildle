...
const FinalCTA = () => {
  return (
    <section id="coming-soon" className="relative bg-[#0391ff] pt-24 pb-48 px-4 md:px-8 overflow-hidden z-0">
      ...
      <div className="max-w-[1200px] mx-auto px-4 md:px-8 relative z-10 flex flex-col items-center">
        ...
        <div className="w-full bg-[#fcff00] rounded-[40px] py-20 px-8 md:px-16 text-center shadow-sm mb-32 transition-transform hover:-translate-y-1">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-[#10252a] leading-tight mb-4 max-w-3xl mx-auto">
        ...
        <div className="text-center w-full max-w-4xl">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white mb-8">
            <div className="w-2 h-2 rounded-full bg-[#0a8a52]"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto">
            <div className="bg-white rounded-[32px] p-10 flex flex-col items-center text-center shadow-lg transition-transform duration-300 hover:-translate-y-2">
              ...
              <div className="px-4 py-1.5 bg-green-50 text-[#0a8a52] text-xs font-bold rounded-full uppercase tracking-wider">
                Coming Soon
              </div>
            </div>
            ...
            <div className="bg-white rounded-[32px] p-10 flex flex-col items-center text-center shadow-lg transition-transform duration-300 hover:-translate-y-2">
              <div className="w-16 h-16 bg-black rounded-2xl flex items-center justify-center mb-6 shadow-md">
                <svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 text-[#ff6e03]">
