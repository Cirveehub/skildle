...
import readbookImg from "../assets/readbook.png";
import planttreeImg from "../assets/planttree.png";
import feedpetImg from "../assets/feedpet.png";
import learnwordsImg from "../assets/learnwords.png";
import bookIcon from "../assets/tabler_book-filled.svg";

const missions = [
  { title: "Read a book", points: "+50", image: readbookImg },
  { title: "Plant a tree", points: "+50", image: planttreeImg },
  { title: "Feed the dog", points: "+50", image: feedpetImg },
  { title: "Learn 5 words", points: "+50", image: learnwordsImg },
];
              ...
              <div className="flex items-center justify-between px-3 pb-3">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-[#9b6cf3] flex items-center justify-center">
                    <img src={bookIcon} alt="Icon" className="w-5 h-5 filter invert brightness-0" style={{ filter: "brightness(0) invert(1)" }} />
                  </div>
                ...
                <div className="flex items-center gap-1.5 bg-[#f8f9fa] px-2.5 py-1 rounded-full border border-gray-100">
                  <span className="text-[12px] font-bold text-custom-black">{mission.points}</span>
